...
import 'package:wysiwyg_flutter_quill/flutter_quill.dart' as fq;
...
class FlutterQuillEmbeds {
  ...
  static List<fq.EmbedButtonBuilder> toolbarButtons({
    ...
    @experimental @Deprecated('tableButtonOptions will no longer used by now, and probably will be removed in future releases.') QuillToolbarTableButtonOptions? tableButtonOptions,
  }) =>
      [
