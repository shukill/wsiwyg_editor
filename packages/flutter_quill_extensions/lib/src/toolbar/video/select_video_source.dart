...
import 'package:wysiwyg_flutter_quill/flutter_quill_internal.dart' show isDesktopApp;
...
Future<InsertVideoSource?> showSelectVideoSourceDialog({
  ...
  final imageSource = await showModalBottomSheet<InsertVideoSource>(
    ...
    builder: (context) => const FlutterQuillLocalizationsWidget(child: SelectVideoSourceDialog()),
  );
  return imageSource;
}
