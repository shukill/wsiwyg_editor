...
class QuillToolbarVideoButton extends StatelessWidget {
  ...
  Future<void> _onPressedHandler(BuildContext context) async {
    ...
    final videoUrl = switch (imageSource) {
      InsertVideoSource.gallery => (await imagePickerService.pickVideo(source: ImageSource.gallery))?.path,
      InsertVideoSource.camera => (await imagePickerService.pickVideo(source: ImageSource.camera))?.path,
