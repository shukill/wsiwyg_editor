...
class CustomTableEmbed extends CustomBlockEmbed {
  ...
  static CustomTableEmbed fromDocument(Document document) => CustomTableEmbed(jsonEncode(document.toDelta().toJson()));
...
class _TableWidgetState extends State<TableWidget> {
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Container(
        decoration: BoxDecoration(border: Border.all(color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.black)),
        child: Column(
