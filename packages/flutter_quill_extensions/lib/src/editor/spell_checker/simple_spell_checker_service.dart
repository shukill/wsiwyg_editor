...
class SimpleSpellCheckerService extends SpellCheckerService<Object?> {
  ...
  @override
  List<TextSpan>? checkSpelling(String text, {LongPressGestureRecognizer Function(String p1)? customLongPressRecognizerOnWrongSpan}) {
  ...
  @override
  void updateCustomLanguageIfExist({required Object? languageIdentifier}) => _featureNoLongerAvailable();
}
