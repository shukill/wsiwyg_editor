...
class _KTextOptionsBottomSheetState extends State<KTextOptionsBottomSheet>
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        padding: const EdgeInsets.all(20), child: _TextOptions(controller: widget.controller));
  }
}
