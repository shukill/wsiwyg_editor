...
class KEditorHelperFunctions {
  static bool _isValidId(String id) => RegExp(r'^[_\-a-zA-Z0-9]{11}$').hasMatch(id);
  ...
  static EditorContentPreview getPreviewVersionOfContent(List<dynamic> content,
      {int charLimit = 200, int mediaLimit = 1}) {
    String totalContent = "";
    ...
    return EditorContentPreview(
        content: previewContent, isOriginal: closingIndex >= content.length && original);
  }
}
