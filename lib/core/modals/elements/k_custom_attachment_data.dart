...
class KCustomAttachmentData {
  ...
  static List<String> audioExtensions = ['mp3', 'MP3', 'aac', 'AAC', 'wav', 'WAV', "webm", "KBM"];
  ...
  final KImageAlignment alignment;
  ...
  bool get isPDF => ['pdf', 'PDF'].contains(extension);
  ...
  bool operator ==(Object other) =>
      ...
      other is KCustomAttachmentData &&
  ...
  KCustomAttachmentData clearCaption() {
    return KCustomAttachmentData(
      id: id,
      mediaID: mediaID,
      url: url,
      thumbnail: thumbnail,
  ...
  KCustomAttachmentData copyWith({
    String? id,
    String? mediaID,
    String? url,
    String? extension,
  ...
  factory KCustomAttachmentData.fromMap(Map<String, dynamic> map) {
    return KCustomAttachmentData(
        id: map['id'] as String,
        ...
        alignment: KImageAlignment.values.firstWhere((e) => e.name == map['alignment']),
