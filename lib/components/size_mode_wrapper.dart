...
class SizeModeWrapper extends StatelessWidget {
  ...
  const SizeModeWrapper({super.key, required this.sizeMode, required this.builder});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      final Size constraint =
          kIsWeb ? Size(constraints.maxWidth, constraints.maxHeight) : MediaQuery.sizeOf(context);
      ...
      return Center(
        child: Container(
          constraints: BoxConstraints(
              minWidth: widthConstraints, maxWidth: widthConstraints, maxHeight: maxHeight),
          child: builder(context, Size(widthConstraints, constraint.width * sizeRatio.height)),
        ),
      );
    });
  }
